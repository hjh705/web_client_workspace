 ...
 */
$(btn10).click(() => {
    const $tbody = $('table#tb_product tbody')
    ...
    _data.forEach(({name, price}) =>{
        ...
        // $tr.append($td1, $td2); // tr 안에 td1, td2 넣어주기
        // // tbody에 추가
        // $tbody.prepend($tr);
        $("<tr></tr>")
...
$(btn11).click(() => {
    ...
    console.log(
        $src
            ...
            // .parents()
            // .parents('div')
            .parentsUntil('div') //src로 지정한 span 다음 요소부터 div까지
            .css(style)
 ...
 * - prevUntile([selector]) 특정태그 다음 형제요소 
 */
$(btn13).click(() => {
