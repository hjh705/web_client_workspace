...
const test1 = () => {
    ...
    // const c = arr[2];
    // const [a, b, c] = arr;
    // const [a, b] = arr; 0, 1번지 대입
    const [, a, b] = arr; // 1, 2번지 대입
    console.log(a, b);
...
const test3 = () => {
    ...
    console.log(id, fn, ln, mainSns, subSns)
...
const test4 = () => {
    ...
    교육원명 : ${name}, 
        ...
        ${Object.keys(branches).reduce((result, branchName, index) => {
            return result += `지점${index + 1} : ${branchName}(${branches[branchName]['addrs']})\n`
        }, "")}
    `);
...
/**
 * 화살표함수에서 객체 반환 시 ()소괄호로 감쌀 것!
 */
const getAcademyInfo = () => ({
    name : 'KH정보교육원',
    url : 'https://khacademy.co.kr',
    tel : ['070-1234-5678', '070-4132- 9292'],
    branches : {
