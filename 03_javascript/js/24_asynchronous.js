 ...
 * - 시간이 오래 걸리는 작업(timer api, dom, event처리)은 백그라운드로 치워뒀다가 이후에 실행(비동기적으로 처리)
 * 
...
document.querySelector('#btn1').addEventListener('click', () => {
    ...
    setTimeout(() => {
        value2 = 100;
        console.log(value2);
    }, 1000) //setTimeout 자체의 우선순위가 후순위이기 때문에 delay를 0으로 해도 undefined 처리됨
    // console.log(value2); //값이 출력되려면 setTimeout 안에 출력구문을 넣어줘야만 한다 
